...
from src.main.logic.interactors.recording import validate_extension, save_uploaded_file
...
async def call_recording(
    ...
    recording = await recording__create(
        uow=uow, call_id=call_id, file_path=file_path)
